    ...
    <main className='flex justify-center items-center h-screen'>
      <div className='w-96 p-6 bg-white border border-gray-200 rounded-lg shadow'>
        ...
        <div className='mt-5'>
          ...
          <Link to='/register' className='text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5'>Register</Link>
        </div>
      </div>
    </main>
  )

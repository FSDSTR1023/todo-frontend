    ...
    <main className=' flex justify-center items-center h-screen'>
      <div className='w-96 p-6 bg-white border border-gray-200 rounded-lg shadow'>
        ...
        <form className='flex flex-col gap-4' onSubmit={submitHandler}>
          <CustomInput label='First Name' type='text' name='firstname' placeholder='Daniel' />
          <CustomInput label='Last Name' type='text' name='lastname' placeholder='Galarza' />
          <CustomInput label='Username' type='text' name='username' placeholder='Pon tu nombre' />
          <CustomInput label='Email' type='email' name='email' placeholder='Danielgalarza@nuclio.es' />
          ...
          <button type='submit' className=' bg-red-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 '>Register</button>
        </form>
        <div className='mt-5'>
          <p className='text-sm text-gray-500 mb-4'>Have an account?</p>
          <Link to='/login' className=' bg-red-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5'>Login</Link>
        </div>
      </div>
    </main>
  )
